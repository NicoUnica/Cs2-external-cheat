...
static void DrawMenu() {
    ...
    dl->AddText(g_fontDefault, 16.f, {wp.x+12, wp.y+8}, hbnx_col(255,255,255), "Nico");
    ...
    ImGui::Checkbox("Spectator List", &g_cfg.spectatorListEnabled);
...
void RenderFrame() {
    ...
    DrawESP();
    if (g_cfg.spectatorListEnabled) DrawSpectatorList();
